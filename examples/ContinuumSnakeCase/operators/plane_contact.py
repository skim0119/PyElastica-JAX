"""Anisotropic-friction rod-plane contact as a JAX block operator."""
...
class SnakePlaneContactJax(eaj.NoOpsJax):
    """Rod-plane contact with anisotropic friction for a single JAX rod.

    This reproduces :class:`elastica.RodPlaneContactWithAnisotropicFriction`:
    elastic and damping normal response combined with axial and rolling kinetic
    friction using direction-dependent friction coefficients.
    """
